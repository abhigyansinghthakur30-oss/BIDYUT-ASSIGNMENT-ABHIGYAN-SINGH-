...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://ywybhgywlcpdkyvqlidd.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl3eWJoZ3l3bGNwZGt5dnFsaWRkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM5OTU4NDIsImV4cCI6MjA4OTU3MTg0Mn0.wFsrJmOZAEppx6pdGOiq0jsPfraTP6VMbki-C4CQX_M");
...
async function POST(request) {
    try {
        ...
        const { data: existingUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("users").select("id").eq("email", email).single();
        if (existingUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const hashedPassword = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password);
        const userRole = role === "admin" ? "admin" : "user";
        const { data: newUser, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("users").insert({
            email,
        ...
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signToken"])({
            id: newUser.id,
            email: newUser.email,
            role: newUser.role
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ddf5656a._.js.map